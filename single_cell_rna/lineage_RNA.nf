...
process CreateCutSitesFile {
    ...
    scala -J-Xmx2g /dartfs/rc/lab/M/McKennaLab/projects/nextflow_lineage/src/fasta_to_cutsites.scala \
        ${sampleId}.fa \
        ${targets} \
        ${params.primer5} \
        ${params.primer3} \
...
process FastqcReport {
    ...
    /dartfs/rc/lab/M/McKennaLab/projects/nextflow_lineage/tools/FastQC/fastqc -o ${sampleId}_fastqc ${read} ${barcode} ${umi}
    """
}
...
process BreakdownFiles {
    ...
    scala -J-Xmx3g /dartfs/rc/lab/M/McKennaLab/projects/nextflow_lineage/src/stats_to_javascript_tables.scala \
    sample.stats \
    ${sampleId}.perBase \
